...
namespace tp5
{
  ...
  namespace csg
  {
    ...
    class subtraction : public shape
    {
    private:
      shape *ShpA, *ShpB; // Shapes
    public:
      /* 'subtraction' class constructor function.
       * ARGUMENTS:
       *   - shapes fo operation:
       *       shape *S1, *S2;
       */
      subtraction( shape *S1, shape *S2 ) : shape(), ShpA(S1), ShpB(S2)
      {
    ...
    }; /* End of 'subtraction' class */
  } /* end of 'csg' namespace */
} /* end of 'tp5' namespace */

#endif /* __subtraction_h_ */

/* END OF 'subtraction.h' FILE */
